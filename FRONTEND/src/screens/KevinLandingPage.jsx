    ...
    return (
        <main className="relative min-h-screen overflow-hidden bg-[#02040F]">
            ...
            <div className="relative z-10 flex min-h-screen flex-col-reverse lg:flex-row pt-6 lg:pt-0">
                ...
                <div className="flex w-full lg:w-1/2 items-center justify-center px-6 py-10 lg:px-14">
                    <div className="max-w-xl text-center lg:text-left">
                        ...
                        <button
                            ...
                            className="group relative inline-flex cursor-pointer items-center justify-center overflow-hidden rounded-full border border-white/20 bg-gray-800/30 px-6 py-3 text-white backdrop-blur-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-white/10"
                        >
                            ...
                            <div className="absolute inset-0 flex justify-center [transform:skew(-13deg)_translateX(-120%)] group-hover:duration-1000 group-hover:[transform:skew(-13deg)_translateX(120%)]">
                                <div className="h-full w-10 bg-white/20" />
                            </div>
                        </button>
                ...
                {/* Image Section */}
                <div className="relative flex w-full lg:w-1/2 items-start justify-center pt-10 md:pt-0 lg:items-center">
